...
/**
 * Created by pedroneto on 20/01/17.
 */
public class Rater {
    ...
    private static final String DEFAULT_TARGET_URI = "market://details?id=com.trimteam.tictactoe";
    private static  String DEFAULT_TEXT_TITLE ;
    private static  String DEFAULT_TEXT_EXPLANATION ;
    private static  String DEFAULT_TEXT_NOW ;
    ...
    public Rater(final Context context, final String packageName) {
        ...
        mText_title = context.getString(R.string.rateTitle);
        mText_explanation = context.getString(R.string.rateContent);
        mText_buttonNow = context.getString(R.string.rateNow);
        mText_buttonLater =  context.getString(R.string.later);
        mText_buttonNever = context.getString(R.string.never);
